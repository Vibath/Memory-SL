...
export default function Contact() {
  return (
    <footer id="contact" className="relative w-full bg-[#050505] text-white pt-24 pb-8 overflow-hidden border-t border-white/5">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-to-t from-[#d4a373]/10 to-transparent blur-[120px] pointer-events-none" />
  ...
  Make a <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#d4a373] to-[#e6c9a5]">Memory.</span>
        ...
        {/* Two-Column Grid: Memory SL & Soundgear */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 mb-24">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="flex flex-col gap-4 font-['Montserrat',sans-serif] text-xs sm:text-sm text-gray-400 font-light tracking-wide">
              <a href="https://www.facebook.com/share/1FDKMjXg4q/?mibextid=wwXIfr" target="_blank" rel="noreferrer" className="flex items-center gap-4 hover:text-[#d4a373] transition-colors duration-300">
                <FaFacebookF size={18} />
                <span>Facebook</span>
              </a>
              <a href="https://www.instagram.com/memory.sl?igsh=bmVuaDNsMWlwNGht" target="_blank" rel="noreferrer" className="flex items-center gap-4 hover:text-[#d4a373] transition-colors duration-300">
                <FaInstagram size={18} />
                <span>Instagram</span>
              </a>
              <a href="https://youtube.com/@memorysl?si=zWSUo0Sh7UdSsWWi" target="_blank" rel="noreferrer" className="flex items-center gap-4 hover:text-[#d4a373] transition-colors duration-300">
                <FaYoutube size={18} />
                <span>YouTube</span>
              </a>
              <a href="https://www.tiktok.com/@memoryslmusic?_t=ZS-8yd5QxY9RPV&_r=1" target="_blank" rel="noreferrer" className="flex items-center gap-4 hover:text-[#d4a373] transition-colors duration-300">
                <FaTiktok size={18} />
                <span>TikTok</span>
              </a>
            </div>
          ...
          {/* =======================
              COLUMN 2: SOUNDGEAR 
              ======================= */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left md:border-l md:border-white/10 md:pl-24">
